...
def returncolor(TrayPosition):
    ...
    tray_groups = {
        ("101", "131", "141"): {
            "P1": ("#FFFF00", "#CCCC00"),  # yellow, dark yellow
            "P2": ("#D8BFD8", "#800080"),  # light purple, purple
        },
        ("102", "132", "142"): {
            "P1": ("#D2B48C", "#A52A2A"),  # light brown, brown
            "P2": ("#D3D3D3", "#A9A9A9"),  # light grey, dark grey
        },
        ("103", "133", "143"): {
            "P1": ("#FFC0CB", "#FF69B4"),  # pink, hot pink
            "P2": ("#40E0D0", "#008080"),  # turquoise, dark turquoise
        },
        ("104", "134", "144"): {
            "P1": ("#00FF00", "#006400"),  # lime, dark lime
            "P2": ("#FFA500", "#FF8C00"),  # orange, dark orange
        }
    }
...
#    ax.hlines(0, -200, 300, colors='k')
    ...
    for i in range(len(List_module_name)):
        ...
        scolor, scolor = returncolor(List_Tray_Position[i])
        ...
        ax.plot(m_rel_pcb_X,    m_rel_pcb_Y,    marker='o', markerfacecolor=scolor, markeredgecolor=scolor, linestyle = 'None', label = 'PCB w.r.t. Baseplate')
