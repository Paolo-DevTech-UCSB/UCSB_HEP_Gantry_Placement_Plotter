...
def returncolor(TrayPosition):
    ...
    # Define tray groups and associated colors
    tray_groups = {
        ("101", "131", "141"): {
            "P1": ("#003CFF", "#001679"),  # yellow, dark yellow
            "P2": ("#003CFF", "#001679"),  # light purple, purple
        },
        ("102", "132", "142"): {
            "P1": ("#C50000", "#6D0000"),  # light brown, brown
            "P2": ("#C50000", "#6D0000"),  # light grey, dark grey
        },
        ("103", "133", "143"): {
            "P1": ("#00FF00", "#006400"),  # pink, hot pink
            "P2": ("#00FF00", "#006400"),  # turquoise, dark turquoise
        },
        ("104", "134", "144"): {
            "P1": ("#F9FD00", "#ABAD00"),  # lime, dark lime
            "P2": ("#F9FD00", "#ABAD00"),  # orange, dark orange
        }
    }

    # Match tray and position
    for tray_set, colors in tray_groups.items():
        if Tray in tray_set:
            return colors.get(Pos, ("#000000", "#000000"))  # default to black if Pos not found

    return ("#000000", "#000000")  # default to black if Tray not matched
...
""""P1": ("#003CFF", "#001679"),  # yellow, dark yellow
    "P2": ("#C761C7", "#B804B8"),  # light purple, purple
},
("102", "132", "142"): {
    "P1": ("#FF8C00", "#8D4B00"),  # light brown, brown
    "P2": ("#C50000", "#6D0000"),  # light grey, dark grey
},
("103", "133", "143"): {
    "P1": ("#88FF00", "#659B00"),  # pink, hot pink
    "P2": ("#00FF88", "#00804A"),  # turquoise, dark turquoise
},
("104", "134", "144"): {
    "P1": ("#00FF00", "#006400"),  # lime, dark lime
    "P2": ("#F9FD00", "#7C7000"),  # orange, dark orange"""