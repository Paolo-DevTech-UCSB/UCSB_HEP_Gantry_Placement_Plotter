...
#    ax.hlines(0, -200, 300, colors='k')
    ...
    for i in range(len(List_module_name)):
        ...
        ax.plot(m_rel_sensor_X, m_rel_sensor_Y, marker='o', markerfacecolor='none',
        markeredgecolor='#ff7f0e', markeredgewidth=2, markersize=12,
        linestyle='None', label='Sensor w.r.t. Baseplate')

        ax.plot(m_rel_pcb_X, m_rel_pcb_Y, marker='o', markerfacecolor='none',
        markeredgecolor='#2ca02c', markeredgewidth=2, markersize=12,
        linestyle='None', label='PCB w.r.t. Baseplate')
...
if __name__ == "__main__":
    ...
    List_module_name = [
        "320MHF1WCSB0023","320MHF1WCSB0024","320MHF1WCSB0025",
        "320MHF1WCSB0026","320MHF1WCSB0027","320MHF1WCSB0028",
        "320MHF1WCSB0029","320MHF1WCSB0030","320MHF1WCSB0031",
        "320MHF1WCSB0032","320MHF1WCSB0033","320MHF1WCSB0034"]
    
    List_rel_sensor_X = [0.014,-0.001,-0.026,-0.051,-0.003,0.002,0.037,-0.035,0.029,-0.012,0.007,0.009]
    List_rel_sensor_Y = [0.001,-0.02,0.031,-0.055,-0.017,-0.016,0.01,0.012,-0.013,0.005,0.02,0.027]
    List_rel_sensor_angle = [-0.002,-0.01,0.01,0.014,-0.003,-0.003,0.001,0.043,-0.021,-0.008,0.003,0.001]
    List_rel_pcb_X = [-0.013,0.03,-0.018,-0.05,0.031,0.021,0.052,-0.023,0.048,-0.035,-0.019,-0.005]
    List_rel_pcb_Y = [-0.003,-0.05,0.019,-0.008,0.018,-0.011,0.006,0.006,0.023,0.008,0.015,0.008]
    List_rel_pcb_angle = [0.025,-0.007,-0.011,0.018,-0.002,-0.001,0.014,0.008,-0.044,-0.031,-0.01,-0.012]
